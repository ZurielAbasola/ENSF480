...
public class SQLConnector {
    ...
    private static Connection createDatabaseConnection(String hostName, String userName, String userPassword, String databaseName) throws SQLException {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            createTable(connection, "CREATE TABLE IF NOT EXISTS Ticket (" +
                "id INT PRIMARY KEY, " +
                "ticketHolderId VARCHAR(255) NOT NULL, " +
                "flight_num INT, " +
                "seat_id INT, " +
                "price FLOAT NOT NULL, " +
